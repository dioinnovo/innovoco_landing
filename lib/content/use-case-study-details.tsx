...
const details: Record<string, UseCaseStudyNarrative> = {
  "executive-self-serve-analytics": {
    ...
    challenge: <>Every board meeting spawns new questions. Without a safe self-serve path, leaders either <strong>wait on overloaded analysts or export spreadsheets and guess</strong>. Traditional self-serve BI often stops at pre-built reports; anything custom still means SQL skills or a request queue. Meanwhile, consumer-style chat over data fails audits: <strong>no row-level security, no proof of which tables fed an answer</strong>, no trail for regulators. So teams throttle access and <strong>strategic decisions slow down</strong> while the business keeps moving.</>,
    solutionIntro:
  ...
  "customer-support-voice": {
    ...
    challenge: <>Customers call in, <strong>wait through outdated phone menus, and get transferred multiple times</strong> before reaching someone who can help. Meanwhile, basic chatbots can only handle FAQs and fall apart the moment a question requires account context or policy knowledge. Support teams want to automate more, but every AI tool they evaluate either <strong>sounds robotic, gives wrong answers, or can't access the customer's actual records</strong>. The result: <strong>rising costs, frustrated customers</strong>, and agents buried in calls that should have been resolved automatically.</>,
    solutionIntro:
    ...
    keyImplementations: [
      ...
      },
      {
        ...
        detail: "When a service interaction resolves, the system surfaces personalized upsell or cross-sell suggestions based on the customer's profile, purchase history, and predicted needs — turning every support call into a revenue opportunity.",
      },
    ],
    technicalInnovation:
  ...
  "regulated-onboarding-kyc-aml": {
    ...
    challenge: <>KYC packets arrive in mixed formats; <strong>analysts re-key data and chase missing proofs</strong>. Regulators expect <strong>explainable decisions, complete trails, and timely escalation</strong>—spreadsheets and email chains fall short.</>,
    solutionIntro:
  ...
  "supply-chain-demand": {
    ...
    challenge: <>A consumer goods manufacturer operating 12 distribution centers and a mixed fleet of 200+ vehicles was <strong>losing $8M annually</strong> to forecast errors, excess inventory, and inefficient logistics. <strong>Demand planning lived in spreadsheets disconnected from the ERP</strong> and warehouse systems. Route planning was manual—dispatchers assigned vehicles based on habit, not data. When EV fleet vehicles were added to meet sustainability targets, range anxiety and charging logistics added a new layer of complexity. <strong>Stockouts hit 14% of SKUs monthly</strong>, while excess inventory tied up <strong>$12M in working capital</strong>.</>,
    solutionIntro:
  ...
  "field-services-iot-playbooks": {
    ...
    challenge: <><strong>Asset telemetry, dispatch, and customer reporting often sit in silos.</strong> Technicians lose time on duplicate data entry; <strong>safety and warranty evidence is scattered</strong>, slowing claims and audits.</>,
    solutionIntro:
  ...
  "finance-close-reconciliation": {
    ...
    challenge: <>High transaction volumes and fragmented subledgers create reconciliation drag. <strong>Manual matching hides errors until late in the close</strong>; <strong>auditors demand traceability that email approvals cannot provide</strong>.</>,
    solutionIntro:
  ...
  "hr-onboarding-policy": {
    ...
    challenge: <>New hires bounce between HR, IT, and facilities trackers. <strong>Equipment delays, missing trainings, and policy gaps create risk</strong>; <strong>hiring managers lack a single status view</strong>.</>,
    solutionIntro:
  ...
  "marketing-personalization": {
    ...
    challenge: <>Campaign tooling outpaces data hygiene. Audiences drift; experiments are under-documented; <strong>sales sees a different customer story than marketing</strong>. <strong>AI-generated copy amplifies the risk if guardrails are weak.</strong></>,
    solutionIntro:
    ...
    impactMetrics: [
      "28% conversion lift from personalized campaigns backed by unified customer profiles and holdout-proven causality.",
      "30% reduction in customer churn driven by real-time behavioral triggers that detect disengagement before cancellation.",
      "15-25% revenue growth from hyper-personalized product recommendations, cross-sell sequences, and retention offers.",
      "Campaign cycle time cut in half with fewer rework loops, automated compliance checks, and a shared vocabulary between growth, finance, and sales.",
    ],
    impactClosing:
      "Personalization moved from a marketing aspiration to a measurable revenue engine. Every customer interaction — email, app, site, service call — draws from the same trusted profile to deliver the right message at the right moment.",
  },
  "reporting-audit-packs": {
    ...
    challenge: <>Reporting teams manually assemble decks from exports and emails. <strong>Lineage is fuzzy; last-minute fixes lack documentation</strong>; <strong>regulators and investors ask questions that take days to answer</strong>.</>,
    solutionIntro:
  ...
  "governed-knowledge-copilot": {
    ...
    challenge: <>Knowledge is scattered across wikis, tickets, and warehouses. <strong>Users paste sensitive questions into consumer tools</strong>; <strong>IT cannot prove who saw what</strong>; <strong>answers lack citations</strong>.</>,
    solutionIntro:
  ...
  "healthcare-capacity-clinical-ops": {
    ...
    challenge: <><strong>Credentialing delays, float pool fragmentation</strong>, and supply shortages show up as last-minute chaos. <strong>Leaders lack an integrated view</strong> tying census, acuity, and staffing rules to actionable schedules.</>,
    solutionIntro:
  ...
  "global-payroll-pay-compliance": {
    ...
    challenge: <><strong>Country-specific rules, backdated adjustments, and FX nuances overwhelm centralized teams.</strong> <strong>Evidence for auditors and tax authorities lives in emails</strong> instead of systems.</>,
    solutionIntro:
  ...
  "visual-inspections-property-cv": {
    ...
    challenge: <>A multi-state roofing and home-services operator was processing thousands of property inspections per month. <strong>Manual photo review slowed estimates, missed subtle hail impact</strong> on shingles, and generated rework when carrier desk reviewers disagreed on damage extent. <strong>Disputes consumed senior adjuster time, delayed settlements, and eroded margins</strong> on jobs that should have been straightforward. Field teams captured inconsistent photo sets—different angles, lighting, and labeling conventions per crew—making <strong>quality assurance reactive rather than systematic</strong>.</>,
    solutionIntro:
  ...
  "cv-quality-control-manufacturing": {
    ...
    challenge: <>An electronics manufacturer running high-mix PCB assembly was <strong>catching only 85% of defects</strong> through manual visual inspection. The <strong>30% false positive rate</strong> generated unnecessary rework, inflated scrap costs, and consumed engineering time on disposition. <strong>Customer escapes triggered warranty claims</strong> and strained key accounts. <strong>Inspection was the bottleneck</strong>: adding shifts was unsustainable, and existing AOI equipment could not keep pace with product changeovers.</>,
    solutionIntro:
  ...
  "medical-imaging-radiology-ai": {
    ...
    challenge: <>A 700-bed academic medical center processed <strong>500+ daily imaging studies</strong> across chest X-rays, CT, and MRI. <strong>Average turnaround was 36 hours</strong>, with <strong>urgent findings sometimes buried in queue</strong>. Treatment delays caused measurable harm—<strong>delayed pneumothorax drainage, missed early-stage nodules</strong>, and patient dissatisfaction scores that lagged peer institutions. Radiologist recruitment could not keep pace with volume growth.</>,
    solutionIntro:
  ...
  "population-health-management": {
    ...
    challenge: <>An ACO managing <strong>125,000 Medicare beneficiaries</strong> struggled to identify high-risk patients across <strong>multiple EHR platforms</strong> (Epic, Cerner, Allscripts). Care management teams allocated <strong>resources reactively—after hospitalizations</strong>—rather than proactively. Quality scores lagged peers, <strong>shared savings targets were missed for two consecutive years</strong>, and care managers spent more time assembling patient profiles than intervening.</>,
    solutionIntro:
  ...
  "sepsis-early-warning-system": {
    ...
    challenge: <>A 350-bed hospital had a <strong>sepsis mortality rate of 28%—well above the national average of 20%</strong>. <strong>Delayed recognition occurred in 40% of cases</strong>, with nurses and residents relying on intermittent vital sign checks and static screening criteria. Alert fatigue from existing rules-based systems meant that <strong>clinicians often dismissed or delayed response</strong> to early warning signals. Each preventable sepsis death cost the institution an estimated <strong>$35,000–$50,000 in excess care</strong> and carried incalculable human cost.</>,
    solutionIntro:
  ...
  "load-renewable-forecasting": {
    ...
    challenge: <>An investor-owned utility in an RTO footprint saw <strong>forecast error growing as distributed solar and EV charging shifted load shapes</strong>. Manual analyst tweaks did not scale across zones; day-ahead MAPE was drifting upward, and <strong>imbalance penalties and unnecessary fuel commitments were costing $8M+ annually</strong>. Weather volatility compounded the problem—<strong>models calibrated on historical norms underperformed</strong> during extreme heat, cold, and cloud events.</>,
    solutionIntro:
  ...
  "grid-asset-health-monitoring": {
    ...
    challenge: <>A regional transmission operator managed <strong>1,200+ substation assets</strong> and 4,000 miles of line with <strong>condition data scattered</strong> across dissolved gas analysis (DGA) labs, partial discharge monitors, thermal imaging reports, and CMMS work history. Maintenance was calendar-driven; critical failures still caused <strong>unplanned outages averaging 14 hours per event</strong>. Planners lacked a unified risk view, so <strong>capital was allocated by age and replacement cost rather than actual condition</strong>.</>,
    solutionIntro:
  ...
  "der-visibility-operations": {
    ...
    challenge: <>A municipal utility with rapidly growing rooftop solar faced a <strong>14-month interconnection queue</strong>. Hosting capacity studies were manual: <strong>engineers ran load flow models one feeder at a time</strong>, with inconsistent assumptions across analysts. Planners lacked feeder-level headroom visibility under realistic heat and cloud scenarios, and developers escalated delays to the public utility commission. The utility needed to <strong>triple throughput without tripling engineering headcount</strong>.</>,
    solutionIntro:
  ...
  "fnol-document-intelligence": {
    ...
    challenge: <>A regional P&C carrier received FNOL through email, portal, phone, and agent channels with no consistent structure. <strong>Adjusters spent 35% of their time normalizing loss details</strong> before they could begin coverage analysis. Missing fields triggered <strong>rework cycles averaging 2.3 touches per claim</strong>. <strong>Severity and peril classification varied by handler</strong>, making downstream triage inconsistent and reporting unreliable.</>,
    solutionIntro:
  ...
  "damage-assessment-field-capture": {
    ...
    challenge: <>A multi-state public adjusting firm handled <strong>2,000+ property claims annually</strong>. Photo and estimate packets varied wildly by adjuster—different angles, missing context shots, inconsistent labeling. Desk reviewers spent <strong>45 minutes per file organizing</strong> and supplementing field packages before carrier submission. <strong>Rework from incomplete submissions added 8–12 days to average settlement timelines</strong> and strained carrier relationships.</>,
    solutionIntro:
  ...
  "fraud-siu-link-analytics": {
    ...
    challenge: <>A national TPA processed 400,000+ claims annually with a rules-based fraud flagging system that produced a <strong>68% false positive rate</strong>. SIU investigators spent the majority of their time dismissing false referrals rather than pursuing actionable cases. Meanwhile, <strong>organized fraud schemes involving coordinated claimants, staged accidents, and complicit vendors were identified only after significant payouts</strong>—often by external audit rather than internal detection.</>,
    solutionIntro:
  ...
  "real-time-fraud-detection": {
    ...
    challenge: <>A regional bank with <strong>$25M in annual fraud losses</strong> across credit card, ACH, and wire channels was running a rules-based detection system with a <strong>65% false positive rate</strong>. Legitimate transactions were declined at a rate that drove customer attrition and call center volume. Fraud analysts spent <strong>80% of their time clearing false alerts</strong> rather than investigating genuine fraud. Meanwhile, sophisticated attacks—<strong>account takeover, synthetic identity, and authorized push payment fraud</strong>—exploited the rule system's inability to detect behavioral anomalies.</>,
    solutionIntro:
    ...
    impactMetrics: [
      ...
      "80% reduction in false positives — fewer legitimate customers blocked means personalization-driven revenue is protected and customer trust stays intact.",
  ...
  "credit-risk-modeling": {
    ...
    challenge: <>A digital lender was <strong>rejecting 40% of applicants who could safely receive credit</strong> because traditional FICO scores could not assess thin-file consumers. The lender served a demographic with high proportions of <strong>recent immigrants, gig workers, and young adults</strong>—populations with limited bureau history but verifiable financial behavior. <strong>Competitors using alternative data were capturing market share</strong>, and regulators expected the lender to demonstrate fair access efforts.</>,
    solutionIntro:
  ...
  "algorithmic-trading-sentiment": {
    ...
    challenge: <>A quantitative hedge fund sought alpha-generating signals from alternative data to complement its existing systematic strategies. <strong>Manual analysis of news and earnings calls was too slow</strong> for short-term trading horizons. Previous NLP vendor solutions delivered sentiment with <strong>multi-hour latency and insufficient granularity</strong>—<strong>sector-level scores rather than entity-level signals</strong> that could drive individual security positions.</>,
    solutionIntro:
  ...
  "deal-flow-ai-diligence": {
    ...
    challenge: <>A middle-market sponsor reviewing 200+ deals annually spent an average of <strong>40 analyst-hours per deal</strong> on initial screening and diligence document processing. <strong>CIMs arrived in varied formats</strong>; financial metrics were buried in narrative, footnotes, and appendices. Analysts reconciled figures across documents manually, and IC memos reflected inconsistent formatting and depth. Portfolio reporting was similarly fragmented—<strong>each portco reported different KPIs in different formats on different schedules</strong>, making operating partner reviews time-consuming and comparisons unreliable.</>,
    solutionIntro:
  ...
  "configurable-bom-product-design": {
    ...
    challenge: <>A manufacturer of configurable interior products—doors, frames, and hardware systems sold to hotel developers and commercial builders—maintained over <strong>8,000 part variants</strong> across 200+ assemblies. Sales engineers spent <strong>2-3 hours per quote manually resolving BOMs</strong> from PDF catalogs and Excel matrices. <strong>Invalid configurations made it to procurement 12% of the time</strong>, triggering rework, delays, and margin erosion. <strong>Compliance verification</strong> for RoHS, REACH, and fire safety standards was a separate manual step that <strong>added another day to each order</strong>. The company needed configuration resolution at quoting speed with built-in compliance gates.</>,
    solutionIntro:
  ...
  "customer-360-identity-resolution": {
    ...
    challenge: <>A multi-channel retailer with 4M+ customer records across e-commerce, point-of-sale, loyalty, mobile app, and customer service systems found that <strong>22% of records were duplicates or fragments</strong> of the same person. Marketing campaigns over-contacted some customers while missing others entirely. The <strong>loyalty program double-counted redemptions</strong>. <strong>Customer lifetime value models were unreliable</strong> because purchase history was split across identities. Previous <strong>deterministic dedup resolved only 40% of duplicates</strong>—the remaining 60% had name variations, address changes, or shared household attributes that required fuzzy matching at scale.</>,
    solutionIntro:
    ...
    phases: [
      ...
      },
      {
        ...
        body: "Applied clustering algorithms to identify groups of records that belong to the same person. Produced golden records with merge provenance and exposed resolved profiles via API to the CDP, CRM, loyalty, and marketing platforms. These unified profiles immediately powered hyper-personalization — recommendation engines, churn prediction models, and next-best-offer decisioning all draw from the same trusted golden record. Consent and preference records follow the golden identity—so opt-outs propagate across all fragments automatically.",
      },
    ],
    keyImplementations: [
      {
    ...
    impactMetrics: [
      ...
      "Hyper-personalization activated at scale — unified profiles powered targeted product recommendations and next-best-offer engines, driving 15-25% revenue uplift from cross-sell and upsell while reducing churn by 30% through proactive retention triggers.",
    ],
    impactClosing:
      "The golden record became the foundation for everything downstream — hyper-personalization, churn prediction, lifetime value optimization, and intelligent recommendations across every customer touchpoint. One trusted profile, powering every decision.",
  },
  ...
  "predictive-maintenance-manufacturing": {
    ...
    challenge: <>An automotive manufacturer was losing <strong>$5M+ annually to unplanned equipment failures</strong>. Each failure averaged <strong>48 hours of downtime</strong>, cascading into missed delivery schedules, overtime labor costs, and expedited shipping. Maintenance was calendar-based—replacing parts on schedule regardless of actual condition, which meant <strong>some components were replaced too early while others failed before their scheduled service</strong>. The maintenance team had <strong>no visibility into which machines were actually at risk</strong>.</>,
    solutionIntro:

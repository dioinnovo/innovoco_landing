...
import { IndustryHeroConfig } from "@/lib/content/industries/types";

interface IndustryHeroProps extends IndustryHeroConfig {
  onCTAClick: () => void;
  image?: string;
  videoUrl?: string;
}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
              ...
              {videoUrl ? (
                ...
                <div className={`aspect-video ${backgroundGradient} relative overflow-hidden`}>
                  ...
                  <div className="absolute inset-0 opacity-30">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-white rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }} />
                  </div>
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 border border-border/20 hidden lg:block"
            >
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-border/20 hidden lg:block"
            >
              <div className="flex items-center gap-3">

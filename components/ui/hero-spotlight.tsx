...
void main() {
  ...
  useEffect(() => {
    ...
    u.lightSpread.value = isMobile ? lightSpread * 2.5 : lightSpread
    u.rayLength.value = isMobile ? rayLength * 1.5 : rayLength
  ...
  return (
    <div className="relative w-full h-full">
      <div
        ref={containerRef}
        className={`absolute inset-0 w-full h-full pointer-events-none z-[1] overflow-hidden ${className}`.trim()}
      />
      {children && (
